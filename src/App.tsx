...
export default function App() {
  ...
  return (
    <div className="bg-[#F9F9F9] text-[#1A1A1A] font-sans selection:bg-[#D4AF37] selection:text-white">
      ...
      {/* Tentang Kami */}
      <section id="tentang" data-aos="fade-right" className="py-24 px-4 overflow-hidden bg-white">
      ...
      {/* Katalog Produk */}
      <section id="katalog" data-aos="fade-left" className="py-24 bg-[#F9F9F9] px-4">
        <div className="max-w-7xl mx-auto">
                  ...
                  <div className="relative overflow-hidden h-64">
                    ...
                    <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                      <button
                        ...
                        className="bg-white text-[#1A1A1A] px-6 py-2.5 rounded-full font-bold transform translate-y-4 group-hover:translate-y-0 transition-transform hover:bg-[#D4AF37] hover:text-white shadow-xl flex items-center gap-2 mx-auto"
                      >
      ...
      {/* Lokasi Cabang */}
      <section id="lokasi" data-aos="zoom-in" className="py-24 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
